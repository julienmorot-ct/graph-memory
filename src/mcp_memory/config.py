...
class Settings(BaseSettings):
    ...
    llmaas_max_tokens: int = (
        60000  # gpt-oss:120b fait du chain-of-thought qui consomme beaucoup de tokens
    )
    ...
    rag_score_threshold: float = (
        0.58  # Score cosinus minimum pour un chunk BGE-M3 (en dessous = ignoré)
    )
...
def get_settings() -> Settings:
    ...
    """
    return Settings()  # type: ignore[call-arg]  # pydantic-settings loads required fields from env vars / .env
